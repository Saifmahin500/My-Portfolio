...
const Skills = () => {
    return (
        <div id="skills" className="text-white w-full my-48 ">
            ...
            <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000" className=" items-center justify-center space-x-3 grid lg:grid-cols-4 grid-cols-2 space-y-5 mx-auto gap-5 max-w-screen-lg aos-init aos-animate">
